...
| RTR pipeline validation | Streaming updates flow from ingestion through to reporting datamart tables | [Pipeline validation](microservices-deployment/real-time-reporting/pipeline-validation.html) |
