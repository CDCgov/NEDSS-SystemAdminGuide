...
Configure the Windows Task Scheduler on your [[classic-nbs|NBS 6]] [[wildfly|WildFly]] server to run the [[elr]] Importer batch process.
...
Continue to [Smoke test](./smoke-test.html).
