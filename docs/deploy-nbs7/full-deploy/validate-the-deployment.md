...
- Your [[classic-nbs|NBS 6]] database refresh is complete and accessible from the test environment.
...
1. Create a test [[case-investigation|investigation]] and confirm that it appears correctly in the UI.
