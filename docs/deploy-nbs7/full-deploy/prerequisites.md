...
- Familiarity with your organization's cloud provider ([[aws]] or [[microsoft-azure|Azure]]) and cloud networking concepts
- Understanding of [[microsoft-sql-server|SQL Server]] database administration, including backup and restore procedures

## NBS 6 readiness

Your [[classic-nbs|NBS 6]] instance is the foundation for [[nbs-7]]. Confirm the following:
...
- **Database server access:** Your cloud environment must have network access to your NBS 6 database server (either on-premises [[amazon-rds|RDS]] or [[amazon-ec2|EC2]] instance, depending on your hosting setup). If the database is on-premises, network connectivity must be established before deployment begins.
...
- **VPC/network setup:** Confirm that your organization can provision and configure virtual private networks ([[amazon-vpc|VPCs]]) or equivalent network isolation and can allow the necessary connectivity.
...
Your deployment requires Domain Name System ([[dns]]) resolution and certificate management:
