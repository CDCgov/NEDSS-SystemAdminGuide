...
- Contain a pre-existing AWS account that contains a production instance of NBS 6 that is listed in the NBS 6 and NBS 7 compatibility matrix page (temporarily unpublished), plus related third-party products such as Rhapsody and SAS
