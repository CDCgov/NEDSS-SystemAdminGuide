...
Both commands must work as expected before you continue. See the [Amazon EKS][eks-troubleshooting] or [AKS][aks-troubleshooting] documentation for troubleshooting guidance.
