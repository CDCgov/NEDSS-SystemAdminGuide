...
<!-- RELEASE CHECKLIST: Review this page each release cycle. Confirm the latest, supported, and unsupported NBS 7 version badges are current before publishing. -->
...
|---|---|---|---|
| 7.13 | New feature | Added {% include term-tooltip.html key="microsoft-azure" term="Microsoft Azure" id="relhist-microsoft-azure" %} as a supported deployment platform, alongside {% include term-tooltip.html key="aws" term="AWS" id="relhist-aws" %}. See [Provision cloud infrastructure](../deploy-nbs7/full-deploy/provision-cloud-infrastructure.html). | {% include term-tooltip.html key="jurisdiction" term="Jurisdictions" id="relhist-jurisdiction" %} can choose a cloud provider based on existing contracts rather than being locked to AWS. |
...
| 7.13 | Notable fix | Fixed a risk where back-button navigation could incorrectly auto-approve or auto-reject {% include term-tooltip.html key="case-notification" term="case notifications" id="relhist-case-notification" %}. Modernized Patient File is now disabled by default until a jurisdiction opts in. | Prevents an unreviewed case notification from being approved or rejected by mistake. |
...
| 7.11.1 | New feature | Patient Profile expanded: editable demographics, superseded-record indicators, and clinical data access for vaccinations, {% include term-tooltip.html key="morbidity-report" term="morbidity reports" id="relhist-morbidity-report" %}, {% include term-tooltip.html key="case-investigation" term="investigations" id="relhist-case-investigation" %}, documents, treatments, {% include term-tooltip.html key="lab-report" term="lab reports" id="relhist-lab-report" %}, and birth records. | A single, more complete patient record view for case investigators. |
...
| Patch | Type | Enhancement | STLT benefit |
|---|---|---|---|
| 7.6.0 | New feature | Real-Time Reporting (RTR) introduced, starting with the Hepatitis Datamart, replacing the existing batch {% include term-tooltip.html key="etl" term="ETL" id="relhist-etl" %} process for that datamart. | First working instance of a long-term goal: real-time instead of overnight-batch reporting data. |
