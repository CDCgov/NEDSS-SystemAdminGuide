...
- The [component reference](../3_component_reference.html) section of this guide
...
2. Work with your vendor to complete steps 4–8 of the [decision tree](2_decision_tree.html) to identify your recommended configuration tier.
