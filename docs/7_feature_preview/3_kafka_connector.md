...
1. Configurations for the following should be on hand to update the `values.yaml` file- RDB_modern hostname, username, password and kafka bootstrap server names.
...
1. Validate service
   ...
   - This is an internal service with no ingress. Validation should be part of [RTR Pipeline Validation](5_rtr_pipeline_validation.html)
