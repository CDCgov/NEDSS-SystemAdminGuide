...
1. **[Deploy cluster infrastructure](../docs/deploy-nbs7/deploy-cluster-infrastructure.html):** Install core Kubernetes infrastructure services (NGINX Ingress, Cert Manager, etc.)
