...
This guide is NOT meant for a production deployment. Please review [AWS Infrastructure](/NEDSS-SystemAdminGuide/docs/3_base_application/0_base_application.html) for a full production deployment and guidelines.
