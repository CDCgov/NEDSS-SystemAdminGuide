...
- **Compatible version:** Your NBS 6 version must be compatible with your target NBS 7 version. Check [Supported NBS versions](./../supported-versions.html) before you begin.
