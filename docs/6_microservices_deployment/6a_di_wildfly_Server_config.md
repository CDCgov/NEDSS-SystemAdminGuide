...
- The document [Windows Task scheduler for ELR Importer](docs/NM-Windows%20Task%20scheduler%20for%20ELRImporter.pdf) provides detailed instructions for creating a task scheduler on a Windows machine.
