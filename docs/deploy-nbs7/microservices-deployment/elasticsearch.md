...
This page walks through deploying [[elasticsearch]] using the `elasticsearch` [[helm-chart|Helm chart]] from the [NEDSS-Helm][nedss-helm-elasticsearch-chart] repository for NBS version {{ site.version_latest }}. This is the first microservice to deploy.
