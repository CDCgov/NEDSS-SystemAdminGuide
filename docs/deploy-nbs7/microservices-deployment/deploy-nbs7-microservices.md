...
| Varies by chart, for example: `ingressHost` | `data.EXAMPLE_DOMAIN` | The domain name for the data ingestion endpoint. Use the value that you configured in the DNS records table during Traefik ingress controller setup. |
