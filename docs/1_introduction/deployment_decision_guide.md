...
1. [Assess your readiness](deployment_decision_guide/0_assess_readiness/) — Readiness checks and prerequisites
2. [Choose your configuration](deployment_decision_guide/1_choose_configuration/) — Decision framework and decision tree
3. [Deploy NBS 7](deployment_decision_guide/2_deploy_nbs7/) — Real-world deployment scenarios and a link to the [NBS 7 System Administrator Guide](https://cdcgov.github.io/NEDSS-SystemAdminGuide/)
4. [Component reference](deployment_decision_guide/3_component_reference/) — Documentation for each NBS 7 component
