...
Before starting this quick start, confirm your NBS 6 version is compatible with your target NBS 7 version on the [Supported NBS versions](./../supported-versions.html) page.
