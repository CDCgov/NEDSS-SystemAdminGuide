...
# Quick deployment of NBS {{ site.version_latest }} in an Amazon Microsoft (AWS) environment

This page provides a streamlined path to deploy NBS 7 infrastructure and core microservices in an Amazon Web Services (AWS) hosting environment. It is intended for experienced administrators familiar with AWS, Kubernetes, Helm, and Terraform.
