...
- [Small jurisdiction, self-managed, AWS](2_deploy_nbs7/1_small_jurisdiction/)
- [Medium jurisdiction, existing middleware, RTR](2_deploy_nbs7/2_medium_jurisdiction/)
- [Large jurisdiction, high volume, vendor-managed](2_deploy_nbs7/3_large_jurisdiction/)
